...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2024-06-08T17:29:04.106Z',
        updatedAt: '2024-06-08T17:29:04.106Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2024-06-08T17:29:04.106Z'))
    expect(result.updatedAt).toEqual(new Date('2024-06-08T17:29:04.106Z'))
  })
